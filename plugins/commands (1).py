...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/sjwiwwpwo"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/skpssksjs')
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
            InlineKeyboardButton('😎 Owner ID 😎', url='https://t.me/mayank4664'),
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Youtube Channel', url='https://youtube.com/@MOTIVATIONCREATORBHAI2.0?si=zVD81Z9yEXDCAyhK')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
